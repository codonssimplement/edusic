      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-black/30 rounded-lg p-4 border border-white/5">
          <div className="flex items-center gap-3 mb-2">
            <div className="w-10 h-10 rounded-full bg-eduGreen/20 flex items-center justify-center">
              <Clock size={20} className="text-eduGreen" />
            </div>
            <div>
          ...
          <div className="mt-3">
            <div className="flex justify-between items-center mb-1">
              ...
              <span className="text-eduGreen font-medium">{completionRate}%</span>
            </div>
        ...
        <div className="bg-black/30 rounded-lg p-4 border border-white/5">
          <div className="flex items-center gap-3 mb-2">
            <div className="w-10 h-10 rounded-full bg-eduGreen/20 flex items-center justify-center">
              <Brain size={20} className="text-eduGreen" />
            </div>
            <div>
          ...
          <div className="mt-3">
            <div className="flex justify-between items-center mb-1">
              ...
              <span className="text-eduGreen font-medium">{retentionRate}%</span>
            </div>
        ...
        <div className="flex items-center gap-4 bg-black/20 rounded-lg p-4 border border-white/5">
          <div className="w-10 h-10 rounded-full bg-eduGreen/20 flex items-center justify-center">
            <Activity size={20} className="text-eduGreen" />
          </div>
          <div>
            ...
            <div className="flex items-center gap-1 mt-1">
              {[1, 2, 3, 4, 5].map((star) => (
                <div 
                  key={star} 
                  className={`w-4 h-4 rounded-full ${star <= 3 ? 'bg-eduGreen' : 'bg-white/20'}`}
                />
              ))}
        ...
        <div className="flex items-center gap-4 bg-black/20 rounded-lg p-4 border border-white/5">
          <div className="w-10 h-10 rounded-full bg-eduGreen/20 flex items-center justify-center">
            <Award size={20} className="text-eduGreen" />
          </div>
          <div>
