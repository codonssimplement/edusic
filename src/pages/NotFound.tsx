      ...
      >
        ...
        >
          <div className="relative">
            <Music size={70} className="text-eduGreen" />
        ...
        <div className="space-y-4">
          <Link to="/">
            <Button variant="default" className="w-full bg-eduGreen text-black hover:bg-eduGreen/90 flex items-center justify-center gap-2 py-6">
              <Home size={18} />
              Retour à l'accueil
            </Button>
          </Link>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-3">
            <Button variant="outline" className="w-full border-gray-700 text-white hover:bg-white/10" onClick={() => window.history.back()}>
